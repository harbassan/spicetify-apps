...
function SettingsIcon(): React.ReactElement<SVGElement> {
    return (
        <svg aria-hidden="true" viewBox="0 0 24 24" className="stats-icon-button-svg">
...
function SettingsButton(props: SettingsButtonProps): React.ReactElement<HTMLButtonElement> {
    ...
    return (
        <button className="stats-icon-button" type="button" onClick={configWrapper.launchModal} aria-label="Settings">
            <SettingsIcon />
        </button>
    );
}
